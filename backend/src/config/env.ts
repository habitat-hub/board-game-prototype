...
const relaxedSchema = baseSchema.extend({
  DATABASE_URL: z.string().default('postgres://user:pass@localhost:5432/testdb'),
  ...
  GOOGLE_CALLBACK_URL: z.string().url().default('http://localhost:8080/auth/google/callback'),
