  ...
  return (
    <div className="fixed inset-0 z-10">
      ...
      >
        ...
        {isCreating ? (
          <RiLoaderLine
            className="w-14 h-14 animate-spin text-kibako-primary bg-kibako-secondary rounded-full p-2 shadow-lg"
            aria-hidden="true"
          />
        ) : (
          /* 通常状態のアイコン */
          <GiWoodenCrate
            className="w-20 h-20 text-kibako-secondary drop-shadow-xl transform -rotate-6 bg-white rounded-2xl p-2 shadow-lg border-2 border-kibako-secondary"
            aria-hidden="true"
          />
        )}
        {/* ボタンテキスト */}
