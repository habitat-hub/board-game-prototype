...
## Prerequisites
- Node.js (see `.tool-versions` or `package.json` "engines") and a single project-wide package manager (npm, pnpm, or yarn)
...
- Do not edit generated files in `frontend/src/api/types/` (ignored by ESLint).
